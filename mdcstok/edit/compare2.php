...
<body>
    ...
    if (isset($_POST['update'])) {
        ...
        $updateReport = "Data updated successfully in MODE A!";
    }
    ...
    if (isset($_POST['update_all'])) {
        ...
        foreach ($data as $row) {
            ...
            // If data does not exist in MODE B, insert data from MODE A into MODE B
            updateData("192.168.4.8", "MODECENTRE", $row['KODEBRG'], $row['DIPAYUDA_B'], "sa", "mode1234ABC");
        }

        // Re-compare the data to refresh the table after updating
        $data = compareData();

        $updateReport = "All data updated successfully in MODE A!";
    }
    ?>
