...
public partial class ReportSalesBySupplierView : Page
{
    private readonly IStorage _store = StorageService.Current;
    private readonly ObservableCollection<Row> _rows = new();

    public ReportSalesBySupplierView()
    {
        InitializeComponent();
    ...
    private void Apply_OnClick(object sender, System.Windows.RoutedEventArgs e)
    {
        ...
        foreach (var (name, total) in _store.SalesBySupplier(from, to)) _rows.Add(new Row(name, total));
    }
